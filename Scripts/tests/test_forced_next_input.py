...
class ForcedNextInputTests(unittest.TestCase):
    def test_forced_output_includes_command_and_required_fields(self) -> None:
        ...
        self.assertEqual(str(nxt.get("callable_prompt_contract", "")), "must_call_lakeside_mem_only")
        ...
        self.assertIn("Lakeside-mem run-target", str(nxt.get("callable_prompt_zh", "")))
        ...
        self.assertIn("generic_advice_without_lakeside_mem_call", forbidden)
